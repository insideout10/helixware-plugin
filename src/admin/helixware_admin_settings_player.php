...
function hewa_admin_settings_player_section() {
	...
	hewa_admin_settings_add_field(
		HEWA_SETTINGS_JWPLAYER_ID, __( 'JWPlayer 6 Key', HEWA_LANGUAGE_DOMAIN ), 'hewa_admin_settings_input_text'
	);
	...
	hewa_admin_settings_add_field(
		HEWA_SETTINGS_JWPLAYER_7_KEY, __( 'JWPlayer 7 Key', HEWA_LANGUAGE_DOMAIN ), 'hewa_admin_settings_input_text'
	);
